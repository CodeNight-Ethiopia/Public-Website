  ...
  <div className="mx-auto max-w-screen-xl px-4 md:px-8">
    ...
    <div className="grid grid-cols-2 gap-x-4 gap-y-6 sm:gap-y-8 lg:grid-cols-3 lg:gap-x-8 lg:gap-y-12">
      ...
      <div className="flex flex-col items-center gap-2 sm:flex-row md:gap-4">
        ...
        <div>
          <div className="text-center font-bold text-indigo-500 sm:text-left md:text-lg">Kate Berg</div>
      ...
      <div className="flex flex-col items-center gap-2 sm:flex-row md:gap-4">
        ...
        <div>
          <div className="text-center font-bold text-indigo-500 sm:text-left md:text-lg">Greg Jackson</div>
      ...
      <div className="flex flex-col items-center gap-2 sm:flex-row md:gap-4">
        ...
        <div>
          <div className="text-center font-bold text-indigo-500 sm:text-left md:text-lg">Robert Greyson</div>
      ...
      <div className="flex flex-col items-center gap-2 sm:flex-row md:gap-4">
        ...
        <div>
          <div className="text-center font-bold text-indigo-500 sm:text-left md:text-lg">John Roberts</div>
      ...
      <div className="flex flex-col items-center gap-2 sm:flex-row md:gap-4">
        ...
        <div>
          <div className="text-center font-bold text-indigo-500 sm:text-left md:text-lg">Judy Amandez</div>
